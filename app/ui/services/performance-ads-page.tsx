      ...
      <section class="py-24 bg-gradient-to-br from-orange-50 to-secondary/5">
        <div class="container mx-auto px-4 max-w-4xl">
          ...
          <div class="flex flex-col gap-8">
            <ProcessStep num={1} title="Account Audit & Competitor Analysis" desc="We audit your current ad accounts (or set them up from scratch) and perform competitor intelligence to identify immediate wins." color="orange" />
            <ProcessStep num={2} title="Strategy & Campaign Architecture" desc="We design a full-funnel campaign structure covering awareness, consideration, and conversion stages with budget allocation recommendations." color="orange" />
            <ProcessStep num={3} title="Creative Development" desc="Our team produces ad creatives — static images, carousels, and short-form videos — designed specifically for paid channel performance." color="orange" />
            <ProcessStep num={4} title="Launch & Initial Optimisation" desc="Campaigns go live and we watch them closely for the first two weeks, making rapid micro-adjustments to CPCs, bids, and audiences." color="orange" />
            <ProcessStep num={5} title="Scale & Monthly Reporting" desc="Once campaigns are profitable, we methodically scale spend, unlock new audiences, and deliver detailed monthly performance reports." color="orange" />
          </div>
        </div>
      </section>
  ...
  return ({ headline, sub }: { headline: string; sub: string }) => (
    <section class="py-24 bg-gradient-to-br from-orange-900 via-orange-700 to-secondary">
      <div class="container mx-auto px-4 max-w-3xl text-center">
        ...
        <p class="text-xl text-orange-100 mb-10">{sub}</p>
